...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        @auth
        <li class="nav-heading mb-1"><img src="{{ asset ('assets/img/jrpImg.png') }}" alt="" width="180px"></li>

        @else
        <li class="nav-heading mb-1"><img src="assets/img/jrpLogo.png" alt="" width="180px"></li>
        @endauth
        <hr>
