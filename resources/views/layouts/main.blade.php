...
<head>
    ...
    <!-- Template Face API JS File -->
    <script defer src="{{ asset('facedetections/face-api.min.js') }}"></script>
    <script defer src="{{ asset('facedetections/script.js') }}"></script>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Jasa Raharja Putera</span>
            </a>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>PT Jasa Raharja Putera</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
